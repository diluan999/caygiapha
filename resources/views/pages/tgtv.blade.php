        ...
        <table class="table table-dark">
            <thead>
                <tr>
                    <th scope="col">STT</th>
                    <th scope="col">Năm</th>
                    <th scope="col">Số Lượng Sinh</th>
                    <th scope="col">Số Lượng Kết Hôn</th>
                    <th scope="col">Số Lượng Mất</th>
                </tr>
            </thead>
            <tbody>
                <?php $stt=1?>
                ...
                <tr>
                    ...
                    <td scope="row" style="color:white">{{$tt->nam}}</td>
                    <td scope="row" style="color:white">{{$tt->soluongsinh}}</td>
                    <td scope="row" style="color:white">{{$tt->soluongkethon}}</td>
                    <td scope="row" style="color:white">{{$tt->soluongmat}}</td>
                </tr>
                @endforeach
            </tbody>
        </table>
